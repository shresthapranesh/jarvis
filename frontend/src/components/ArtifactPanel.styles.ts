...
export const panel = stylex.create({
  ...
  itemMeta: {fontSize: '0.7rem', color: colors.textDim},
...
export const detail = stylex.create({
  ...
  title: {fontSize: '1.1rem', fontWeight: 600, marginBlock: '4px 2px', color: colors.text},
  content: {fontSize: '0.9rem', lineHeight: 1.55},
  media: {maxWidth: '100%', width: '100%', borderRadius: 8},
});
...
export const version = stylex.create({
  ...
  hint: {fontSize: '0.75rem', opacity: 0.7},
  ...
  meta: {fontSize: '0.72rem', color: colors.textDim, flexShrink: 0},
