...
const styles = stylex.create({
  ...
  title: {fontSize: type.tBody, fontWeight: 600, color: colors.text, marginBlockEnd: 8},
  body: {fontSize: type.tBody, color: colors.textDim, lineHeight: 1.5},

  typed: {marginBlockStart: 14, display: 'flex', flexDirection: 'column', gap: 6},
  typedLabel: {fontSize: type.tSmall, color: colors.textDim},
  typedName: {
    color: colors.text,
