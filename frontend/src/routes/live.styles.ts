...
export const live = stylex.create({
  ...
  empty: {textAlign: 'center', color: colors.textDim, fontSize: '0.85rem', margin: 'auto'},
  ...
  unsupportedTitle: {fontSize: '1rem', color: colors.text},
  unsupportedBody: {fontSize: '0.85rem', lineHeight: 1.6},
});
